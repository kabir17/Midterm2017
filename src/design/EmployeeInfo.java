...
public class EmployeeInfo extends EmployAbstract implements Employee{
 ...
 */
	 ...
	 * 
	 */
	public static double calculateEmployeeBonus(double employee1Salary, double salary, String employeeName, int performance){
		double total=0;
		if(performance == 5) {
			total = salary * .10;
	...
	public static double calculateEmployeePension(double salary){
		...
		if(numberOfYears >=5){				// 5%
			total = salary*.25;				// >= 5 giving value
		}else if (numberOfYears == 4){
			total = salary * .20;									// == boolean equal
	...
	public void benefitLayout() {
		System.out.println("All employees should get benefit");
	}
